...
import { ApolloAuthRepository, ApolloUserRepository, ApolloTracksRepository, ZustandAuthTokenStateRepository, HTML5PlayerAudioRepository } from "@genz-deezer/infrastructure"
...
export const html5PlayerAudioRepository = new HTML5PlayerAudioRepository()
